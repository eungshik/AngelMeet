...
--
-- Host: 192.168.7.49    Database: angelmeet
-- ------------------------------------------------------
...
CREATE TABLE `reservation` (
  ...
  PRIMARY KEY (`rid`),
  KEY `reservation_FK` (`mid`),
  CONSTRAINT `reservation_FK` FOREIGN KEY (`mid`) REFERENCES `meeting_room` (`mid`)
...
INSERT INTO `reservation` VALUES (1,'2023-11-16 20:00:00','2023-11-16 19:39:39','WEB001',0,'2023-11-16 19:39:39','WEB001',NULL,NULL,NULL,'2023-11-16 19:30:00','test','test',1,NULL),(2,'2023-11-16 21:00:00','2023-11-16 19:40:08','WEB001',0,'2023-11-16 19:40:08','WEB001',NULL,NULL,NULL,'2023-11-16 20:30:00','test','test',1,NULL),(3,'2023-11-16 23:00:00','2023-11-16 20:09:54','WEB001',0,'2023-11-16 20:09:54','WEB001',NULL,NULL,NULL,'2023-11-16 21:00:00','엔젤넷개발회의','엔젤넷개발회의',1,NULL);
...
-- Dump completed on 2023-11-17 14:38:54
